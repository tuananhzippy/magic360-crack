...
var Magic360 = (function () {
    ...
    w.prototype.preInit = function (D) {
        ...
        if ("undefined" !== typeof (h)) {
            ...
            f(this.o).jStore("cr", u.$new(((Math.floor(Math.random() * 101) + 1) % 2) ? "span" : "div"));
    ...
    var m = function () {
        return "mgctlbxN$M360 mgctlbxV$" + "v4.6.12".replace("v", "") + " mgctlbxL$" + "t".toUpperCase() + ((window.mgctlbx$Pltm && "string" == u.jTypeOf(window.mgctlbx$Pltm)) ? " mgctlbxP$" + window.mgctlbx$Pltm.toLowerCase() : "")
    };
    var j = f([]);
    var o = {
        version: "v4.6.12 DEMO",
        options: {},
        lang: {},
        callbacks: {},
        start: function (C) {
